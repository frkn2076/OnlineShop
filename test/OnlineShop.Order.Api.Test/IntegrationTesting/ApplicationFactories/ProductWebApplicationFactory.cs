...
using ProductProgram = OnlineShop.Product.Grpc.Program;

namespace OnlineShop.Order.Api.Test.IntegrationTesting.ApplicationFactories;

public class ProductWebApplicationFactory : WebApplicationFactory<ProductProgram>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseUrls("https://localhost:7213");
    }
}